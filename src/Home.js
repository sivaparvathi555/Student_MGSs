 ...
 render()
 {
   return(
   	...
   	<View style ={styles.container}>
   		...
   		<View style={{flex:1,width:'100%',height:'100%',marginTop:55,}}>
   			<Text style ={styles.textContent1}> Studentmgs</Text>
   			<Text style ={styles.textContent}> Management </Text>
        <Text style ={styles.textContent}> System </Text>
